		...
		<div class="top-bar clearfix" style="background-color: red">
			<div class="container">
				...
				<ul class="list-inline pull-left quick-contact">
					...
					<li>
                        <a target="_blank" class="button" href="https://rpireport.com/" ><i class="fas fa-file"></i> <span>NPRI 2025</span></a>
                    </li>

					<li>
                        <a target="_blank" class="button" href="https://nprweek.niprng.org.ng/" ><i class="fa fa-link"></i> <span>NPRWeek 2026</span></a>
                    </li>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown {{(Route::is('resources.event'))?"active":''}}">
							...
							<ul class="dropdown-menu" style="text-transform: unset">
							   ...
							   <li>
								   <a target="_blank" href="https://rpireport.com/" style="text-transform: unset" >NPRI 2025</a>
							   </li>
							   <li>
						...
						{{-- <li class="
						    {{(Route::is('contactus'))?"active":''}} "><a wire:navigate href="/contact-us" style="text-transform: unset">Contact</a></li> --}}
							 <ul class="dropdown-menu">
								...
								<li>
									<a  href="https://rpireport.com/" style="text-transform: unset;">NPRI 2025</a>
								</li>
							</ul>
						</li>
